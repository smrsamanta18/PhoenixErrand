...
protocol ProfileServicesProtocol {
    func getProfileDetails(completion: RequestCompletionHandler?)
}
class ProfileServices: ProfileServicesProtocol {
    
    func getProfileDetails(completion: RequestCompletionHandler?) {
        let introURL = APIConstants.profileServicesApi()
        ...
        Alamofire.request(introURL, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: header).responseObject {(response: DataResponse<ProfileModel>) in
